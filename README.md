# Система управления заявками на ремонт оборудования

## Описание

Это приложение с графическим интерфейсом пользователя (GUI) на JavaFX для управления заявками на ремонт оборудования. 
...
- **Управление заявками:**
    ...
    - Редактирование существующих заявок (только для администраторов).
    - Удаление заявок (только для администраторов).
